...
void WallBall::setupLevel() {
	...
	// Portals
	GOPortal::setupPortal(-33.0f, 6.5f, 33.0f, 37.5f, "assets/color3.bmp");
	GOPortal::setupPortal(-33.0f, 23.5f, 33.0f, 23.5f, "assets/color5.bmp");
	GOPortal::setupPortal(-33.0f, 37.5f, 33.0f, 6.5f, "assets/color8.bmp");
}
